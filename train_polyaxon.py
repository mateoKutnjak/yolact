...
parser.add_argument('--save_folder', default=get_outputs_path(),
...
def compute_validation_map(epoch, iteration, yolact_net, dataset, log:Log=None):
    with torch.no_grad():
        ...
        experiment.log_metrics(step=epoch,
                               box_all=val_info['box']['all'],
                               mask_all=val_info['mask']['all'],
                               box_50=val_info['box'][50],
                               box_55=val_info['box'][55],
                               box_60=val_info['box'][60],
                               box_65=val_info['box'][65],
                               box_70=val_info['box'][70],
                               box_75=val_info['box'][75],
                               box_80=val_info['box'][80],
                               box_85=val_info['box'][85],
                               box_90=val_info['box'][90],
                               box_95=val_info['box'][95],
                               mask_50=val_info['mask'][50],
                               mask_55=val_info['mask'][55],
                               mask_60=val_info['mask'][60],
                               mask_65=val_info['mask'][65],
                               mask_70=val_info['mask'][70],
                               mask_75=val_info['mask'][75],
                               mask_80=val_info['mask'][80],
                               mask_85=val_info['mask'][85],
                               mask_90=val_info['mask'][90],
                               mask_95=val_info['mask'][95],
                               )
